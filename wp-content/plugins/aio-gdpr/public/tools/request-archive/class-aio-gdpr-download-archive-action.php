...
Class AIOGDPR_DownloadArchiveAction extends AIOGDPR_AjaxAction{
    ...
    public function run(){
        ...
        $this->sar = AIOGDPR_SubjectAccessRequest::finder('token', array(
...
AIOGDPR_DownloadArchiveAction::listen();
