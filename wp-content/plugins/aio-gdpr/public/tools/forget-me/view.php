<h1>Forget Me</h1>
<p><?= AIOGDPR_Settings::get('forget_me_form_description') ?></p>
<br>

<form method="post" action="<?= AIOGDPR_ForgetMeAction::formURL() ?>">
    <input type="hidden" name="action" value="<?= AIOGDPR_ForgetMeAction::action() ?>" />
