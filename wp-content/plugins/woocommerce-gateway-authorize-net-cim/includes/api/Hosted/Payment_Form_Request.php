...
class Payment_Form_Request extends \WC_Authorize_Net_CIM_API_Request {
	...
	private function get_customer() {
		...
		if ( is_email( Framework\SV_WC_Order_Compatibility::get_prop( $this->get_order(), 'billing_email' ) ) ) {
			$customer['email'] = Framework\SV_WC_Order_Compatibility::get_prop( $this->get_order(), 'billing_email' );
		}
