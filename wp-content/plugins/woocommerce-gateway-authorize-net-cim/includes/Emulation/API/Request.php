...
class Request implements Framework\SV_WC_Payment_Gateway_API_Request {
	...
	private function set_addresses() {
		...
		$billing_country  = Framework\SV_WC_Helper::convert_country_code( $this->get_order()->get_billing_country() );
		$shipping_country = Framework\SV_WC_Helper::convert_country_code( $this->get_order()->get_shipping_country() );
