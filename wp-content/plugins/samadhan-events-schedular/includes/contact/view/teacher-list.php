...
class TeacherAdd extends UserCRUD{

    public function __construct()
    {
        add_shortcode('smdn_teacher_list','TeacherAdd::get_contact_form_teacher_list');
    }


    public static function get_contact_form_teacher_list($atts){
        ...
        */
        ...
        foreach ($getUsers['results'] as $user){
            ...
            $body .=" <tr>
                        ...
                        <td>".get_user_meta($user->ID,'SchoolName',true)."</td>
                        <td>".get_user_meta($user->ID,'Subjects',true)."</td>
                        <td>".get_user_meta($user->ID,'GradeLevelTeach',true)."</td>
                        <td>".get_user_meta($user->ID,'Duration',true)."</td>
                        <td>".get_user_meta($user->ID,'SpecificTopics',true)."</td>
                        <td><a style='font-size: 25px;margin-right: 10px;' href=".home_url('/edit-teacher/?user_id='.$user->ID)."><span class='btn btn-small btn-info '>&#9998;</span></a><a style='font-size: 25px' href=".home_url('/teacher_list/?user_id='.$user->ID)."><span class='btn btn-small btn-danger'>&#10005;</span> </a></td>
