...
class WC_API_Client {
    ...
    public function create_customer( $params = array() ) {
        return $this->_make_api_call( 'customers/', $params ,'POST');
    }
     ...
     * @return mixed|json string
     */
    public function get_reports_total() {
        $totals = $this->_make_api_call( 'reports/orders/totals');
        $total_order = 0;
    ...
    public function get_shipping_method( ) {
        return $this->_make_api_call( 'shipping_methods');
    }
     ...
     * @return mixed|json string
     */
    public function get_shipping_zone($order_id ) {
        return $this->_make_api_call( 'shipping/zones',$order_id);
