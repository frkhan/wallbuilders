...
class AdminSettings{
    ...
    public function samadhan_consumer_key_settings() {
        ...
        add_option( 'SAMADHAN_STORE_BLOG_ID', 'Enter Store Site Blog ID');
        ...
        register_setting( 'samadhan_consumer_key_form_group', 'SAMADHAN_STORE_BLOG_ID', '' );
        ...
        <div style=" background-color:#fff; margin-right:14px; margin-top:14px; padding-left:14px; border-left:  4px solid #00a0d2; border-top: 1px solid #00a0d2;border-right: 1px solid #00a0d2;border-bottom: 1px solid #00a0d2;">
            ...
            <form method="post" action="options.php">
                ...
                <table style="margin-left: 8%;">
                    ...
                    <tr>
                        <th scope="row" style="width: auto%; text-align: left; "><label for="SAMADHAN_STORE_BLOG_ID">Store Site Blog ID : </label></th>
                        <td style="text-align: left; ">
                            <input style="height:35px; margin-left: 60px;" type="text" size="80"  id="SAMADHAN_STORE_BLOG_ID" name="SAMADHAN_STORE_BLOG_ID" value="<?php echo esc_html( sprintf( __('%s', 'textdomain' ), get_option( 'SAMADHAN_STORE_BLOG_ID' ) ) ); ?>" />
                        </td>
                    </tr>
