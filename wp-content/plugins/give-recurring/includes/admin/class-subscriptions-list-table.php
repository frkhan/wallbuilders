			...
			<div id="give-payment-date-filters">
				<div class="give-filter give-filter-half">
					...
					<input type="text" id="start-date" name="start-date" class="give_datepicker"
					       ...
					       placeholder="<?php esc_attr_e( 'Start Date', 'give-recurring' ); ?>" />
				</div>
				<div class="give-filter give-filter-half">
					<label for="end-date"
					       class="give-end-date-label"><?php esc_html_e( 'End Date', 'give-recurring' ); ?></label>
					<input type="text" id="end-date" name="end-date" class="give_datepicker"
					       value="<?php echo $end_date; ?>" placeholder="<?php esc_html_e( 'End Date', 'give-recurring' ); ?>" />
				</div>
			</div>
