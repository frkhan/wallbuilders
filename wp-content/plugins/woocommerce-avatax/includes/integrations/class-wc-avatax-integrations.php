...
class WC_AvaTax_Integrations {
	 ...
	 * Removes tax calculation meta from a newly created subscription's items.
	 *
	 * TODO: remove after 2020-08 or by version 2.0.0 {FN 2019-08-12}
	 *
	 * @internal
	 * @deprecated 1.8.0
	 *
	 ...
	 * @throws \Exception
	 */
	public function remove_new_subscription_item_meta_legacy( $item_id ) {

		wc_deprecated_function( __METHOD__, '1.8.0' );

		wc_delete_order_item_meta( $item_id, '_wc_avatax_origin_address' );
		wc_delete_order_item_meta( $item_id, '_wc_avatax_destination_address' );
	}
