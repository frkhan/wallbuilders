...
class RushOrder extends GetOrder {

    public function __construct()
    {
        add_shortcode('pod_rush_order_reports','Samadhan\RushOrder::smdn_woocommerce_rush_order_reports');
    }


    public static function smdn_woocommerce_rush_order_reports(){
