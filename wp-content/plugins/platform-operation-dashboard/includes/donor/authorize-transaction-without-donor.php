...
class AuthorizeTransactionWithoutDonor extends GetOrder {

    public function __construct()
    {
        add_shortcode('pod_maintain_authorize_transactions_without_donors','Samadhan\AuthorizeTransactionWithoutDonor::smdn_woocommerce_maintain_authorize_exception_reports_without_donor');
    }



    public static function smdn_woocommerce_maintain_authorize_exception_reports_without_donor(){
        ...
        self::smdn_maintain_authorize_exception__without_donor_form($postFrom_date,$postTo_date,$currentPageNumber);
...
//var_dump($orders);
    ...
    public  static  function smdn_maintain_authorize_exception__without_donor_form($from_date, $to_date,$currentPageNumber){
        ?>
...
new AuthorizeTransactionWithoutDonor();