...
class AuthorizeException extends GetOrder {

    public function __construct()
    {
        add_shortcode('pod_maintain_authorize_exception_reports','Samadhan\AuthorizeException::smdn_woocommerce_maintain_authorize_exception_reports');
    }


    public static function smdn_woocommerce_maintain_authorize_exception_reports(){
        ...
        self::smdn_maintain_authorize_exception_form($postFrom_date,$postTo_date,$currentPageNumber);
...
//var_dump($orders);
    ...
    public  static  function smdn_maintain_authorize_exception_form($from_date, $to_date,$currentPageNumber){
        ?>
