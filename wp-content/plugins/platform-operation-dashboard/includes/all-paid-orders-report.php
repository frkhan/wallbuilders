...
class AllPaidOrder extends GetOrder {

    public function __construct()
    {
        add_shortcode('pod_paid_orders_partial_payment_reports','Samadhan\AllPaidOrder::smdn_woocommerce_paid_orders_partial_payment_reports');
    }


    public static function smdn_woocommerce_paid_orders_partial_payment_reports(){
...
//var_dump($orders);
            ...
            $membership_table .= '<thead style="color: white; background-color: rgb(69, 88, 97);">
                                   <tr  style="color: white; background-color: rgb(69, 88, 97);">
                                      ...
                                      <th scope="row" colspan="6">Total Orders = '.$total_order_count.'</th>                                
...
//var_dump($order);
            ...
            $membership_table .= '<tfoot><tr  style="color: white; background-color: rgb(69, 88, 97);">
                                     ...
                                     <tr  style="color: white; background-color: rgb(69, 88, 97);">
                                      <th scope="row" colspan="10">Showing ' . $current_page . ' to  ' . $order_per_page . ' of total ' . $order_count_by_filter . ' entries</th>
                                      <th></th>                                  
                                      <th><a href="JavaScript:PrevPage();">Prev</a> </td>
                                      <th><a href="JavaScript:NextPage();">Next</a> </td>                                   
                                    </tr>
